...
var App = (function () {
  ...
  var GUIDE = [
    ...
    ['b', '여러 줄을 붙여넣으면 셀이 줄 수만큼 늘어나 한 줄씩 펼쳐집니다.'],
    ['b', '보이는 줄이 곧 시트1에서 칠 줄이라 줄바꿈을 바로 확인할 수 있습니다.'],
    ['b', '인터넷에서 긁어온 글도 줄바꿈을 살려 넣습니다. 메모장을 거칠 필요가 없습니다.'],
    ['b', '복사를 막는 사이트라 줄이 뭉개져 들어와도 셀 안에서 바로 나눌 수 있습니다.'],
    ['b', '셀을 더블클릭한 뒤 나눌 자리에서 Alt+Enter 를 누르면 그 자리에서 줄이 나뉩니다.'],
    ['b', 'Enter 로 확정, Esc 로 취소합니다. 메모장을 열 일이 없습니다.'],
    ['b', '수식 입력줄에서는 줄바꿈이 화살표(↵) 로 보입니다.'],
    ['', ''],
    ['h', '시트2  여러 칸 선택과 지우기'],
    ...
    ['', ''],
    ['h', '기록과 이력'],
    ['b', '공유 버튼을 누르면 타임어택 기록을 상위 10명까지 보여 줍니다.'],
    ['b', '기록에는 프로필의 아이디와 사진이 함께 남습니다.'],
    ['b', '기록은 이 브라우저에만 쌓입니다. 기록 복사로 남에게 보낼 수 있습니다.'],
    ['b', '업그레이드 버튼을 누르면 업데이트 이력이 보입니다.'],
    ['', ''],
    ['h', '제목과 프로필'],
  ...
  function init() {
    ...
    hint.innerHTML =
      ...
      '붙여넣은 <b>줄바꿈은 그대로</b> 셀 안에 펼쳐집니다. (가사 · 시)<br>' +
      '줄이 뭉개져 들어왔다면 셀 안에서 <b>Alt+Enter</b> 로 나누세요.';
