...
한 줄을 끝내고 `Enter` 를 누르면 그 줄의 **글과 입력한 글이 사라지고 업무용 데이터로 바뀝니다.**
도서관 수서 담당자의 **구입도서 신청목록**처럼 보이게 되어 있습니다.
...
바뀐 셀을 클릭하면 수식 입력줄에 함수가 보입니다. (`=ROUND($E4*$F4,0)` 처럼)

연습을 이어갈수록 화면이 점점 평범한 신청목록이 됩니다.
